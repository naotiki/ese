...
#       https://github.com/gradle/gradle/blob/master/subprojects/plugins/src/main/java/org/gradle/api/internal/plugins/UnixStartScriptGenerator.java
#
...
#       https://github.com/gradle/gradle/blob/master/subprojects/build-init/src/main/java/org/gradle/api/tasks/wrapper/Wrapper.java
...
<% } %>
JAVA_HOME=\$APP_HOME/lib/runtime/
